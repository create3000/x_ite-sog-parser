...
[![jsDelivr Hits](https://data.jsdelivr.com/v1/package/npm/x_ite-sog-parser/badge?style=rounded)](https://create3000.github.io/jsdelivr-download-stats/?username=create3000&repository=x_ite-sog-parser)
...
```html
<script defer src="https://cdn.jsdelivr.net/npm/x_ite-sog-parser@1.2.2/dist/x_ite-sog-parser-2.min.js"></script>
<script defer src="https://cdn.jsdelivr.net/npm/x_ite@VERSION/dist/x_ite.min.js"></script>
<!-- or as ES module -->
<script type="module" src="https://cdn.jsdelivr.net/npm/x_ite-sog-parser@1.2.2/dist/x_ite-sog-parser-2.min.js"></script>
